    ...
    public List<Map<String, Object>> getTestCaseList(Integer projectID, Integer groupID) {
        ...
        if (childGroupList != null && !childGroupList.isEmpty()) {
            for (Map<String, Object> group : childGroupList) {
                ...
                List<Map<String, Object>> childGroupList1 = automtedTestCaseGroupMapper.getChildGroupList(projectID, new Integer(group.get("groupID")
                        .toString()));
        ...
        if (caseList != null && !caseList.isEmpty()) {
            ...
            for (Map<String, Object> caseData : caseList) {
                ...
                Integer topParentGroupID = automtedTestCaseGroupMapper.getParentGroupID(new Integer(caseData.get("parentGroupID")
                        .toString()));
